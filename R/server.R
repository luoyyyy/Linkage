server <- function(input, output, session) {
  ...
  observeEvent(input$submit6, {
    tryCatch({
      ...
      updateProgressBar(
        session = session,
        id = "simulationProgress",
        title = "The app is constructing the GRNs...",
        value = 10
      )
      ...
      updateProgressBar(
        session = session,
        id = "simulationProgress",
        title = "This will take some time, please be patient...",
        value = 30
      )
  ...
  observeEvent(input$submit7, {
    progressSweetAlert(
      ...
      title = "The app is performing the GO enrichment analysis...",
      display_pct = TRUE,
      value = 20
    )
    ...
    updateProgressBar(
      session = session,
      id = "simulationProgress6",
      title = "The app is performing the KEGG enrichment analysis...",
      value = 50
    )
    ...
    tryCatch({
      ...
      updateProgressBar(
        session = session,
        id = "The app is performing the KEGG enrichment analysis...",
        value = 100
      )
